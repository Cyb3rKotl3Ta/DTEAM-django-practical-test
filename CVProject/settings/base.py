"""
Base settings for CVProject.

This file contains common settings that are shared across all environments.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-@1p3@mf2eak-qqor*ir%usiah2%p0fg_cg=ya903025s+-7&u%')
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@cvproject.com')
